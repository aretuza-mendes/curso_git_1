...
class TreeNodeInfo extends vscode.TreeItem {
    constructor(label, contextValue, collapsibleState, nodePath, nodeStatus, nodeType, sessionId, connectionInfo, parentNode, objectMetadata) {
    ...
    static fromNodeInfo(nodeInfo, sessionId, parentNode, connectionInfo, label, nodeType) {
        ...
        const treeNodeInfo = new TreeNodeInfo(label ? label : nodeInfo.label, type, nodeInfo.isLeaf ? vscode.TreeItemCollapsibleState.None :
            (type === Constants.serverLabel ? vscode.TreeItemCollapsibleState.Expanded :
                vscode.TreeItemCollapsibleState.Collapsed), nodeInfo.nodePath, nodeInfo.nodeStatus, type, sessionId, connectionInfo, parentNode, nodeInfo.metadata);
