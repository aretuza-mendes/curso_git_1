        ...
        const handler = (result) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (result.success) {
                ...
                if (self._currentNode && (self._currentNode.sessionId === result.sessionId)) {
                    nodeLabel = !nodeLabel ? (0, connectionInfo_1.getConnectionDisplayName)(self._currentNode.connectionInfo) : nodeLabel;
                    ...
                    nodeLabel = !nodeLabel ? (0, connectionInfo_1.getConnectionDisplayName)(nodeConnection) : nodeLabel;
    ...
    getSavedConnections() {
        ...
        for (const conn of savedConnections) {
            let nodeLabel = conn.label === conn.connectionCreds.server ?
                (0, connectionInfo_1.getConnectionDisplayName)(conn.connectionCreds) : conn.label;
