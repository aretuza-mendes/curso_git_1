 ...
 */
    ...
    createFirewallRule(serverName, ipAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            let result = yield this._vscodeWrapper.showInformationMessage(Utils.formatString(LocalizedConstants.msgPromptRetryFirewallRuleSignedIn, ipAddress, serverName), LocalizedConstants.createFirewallRuleLabel);
