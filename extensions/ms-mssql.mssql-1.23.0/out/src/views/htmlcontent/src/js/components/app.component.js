    ...
    constructor(dataService, shortcuts, _el) {
        ...
        this.shortcutfunc = {
            ...
            'event.selectAll': () => {
                ...
                grid.selection = [
                    new Slick.Range(0, 1, grid._grid.getDataLength() - 1, grid._grid.getColumns().length - 1)
                ];
            },
            'event.saveAsCSV': () => {
        ...
        this.dataIcons = [
            {
                ...
                functionality: (batchId, resultId, index) => {
                    this.magnify(index);
                    this.dataService.sendActionEvent(telemetryInterfaces_1.TelemetryViews.ResultsGrid, telemetryInterfaces_1.TelemetryActions.ResultPaneAction, {
