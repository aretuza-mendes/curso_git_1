...
class QueryRunner {
    ...
    handleQueryComplete(result) {
        ...
        (0, telemetry_1.sendActionEvent)(telemetryInterfaces_1.TelemetryViews.QueryEditor, telemetryInterfaces_1.TelemetryActions.QueryExecutionCompleted, undefined, {
