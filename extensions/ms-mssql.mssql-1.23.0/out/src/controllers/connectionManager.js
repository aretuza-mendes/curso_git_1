...
class ConnectionManager {
    ...
    handleConnectionSuccess(fileUri, connection, newCredentials, result) {
        ...
        (0, telemetry_1.sendActionEvent)(telemetryInterfaces_1.TelemetryViews.ConnectionPrompt, telemetryInterfaces_1.TelemetryActions.CreateConnectionResult, undefined, undefined, newCredentials, result.serverInfo);
    }
    handleConnectionErrors(fileUri, connection, result) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (0, telemetry_1.sendErrorEvent)(telemetryInterfaces_1.TelemetryViews.ConnectionPrompt, telemetryInterfaces_1.TelemetryActions.CreateConnectionResult, new Error(result.errorMessage), false, (_a = result.errorNumber) === null || _a === void 0 ? void 0 : _a.toString(), undefined, {
                'containsError': 'true'
