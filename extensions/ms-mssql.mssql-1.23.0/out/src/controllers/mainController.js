...
class MainController {
    ...
    activate() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (didInitialize) {
                ...
                this._event.on(Constants.cmdClearPooledConnections, () => __awaiter(this, void 0, void 0, function* () { yield this.onClearPooledConnections(); }));
    ...
    scriptNode(node_1, operation_1) {
        return __awaiter(this, arguments, void 0, function* (node, operation, executeScript = false) {
            ...
            (0, telemetry_1.sendActionEvent)(telemetryInterfaces_1.TelemetryViews.QueryEditor, telemetryInterfaces_1.TelemetryActions.RunQuery, {
    ...
    initializeObjectExplorer() {
        ...
        if (this.isExperimentalEnabled) {
            ...
            this._event.on(Constants.cmdAddObjectExplorer2, () => __awaiter(this, void 0, void 0, function* () {
                const connDialog = new connectionDialogWebViewController_1.ConnectionDialogWebViewController(this._context, this, this._objectExplorerProvider);
            ...
            this._context.subscriptions.push(vscode.commands.registerCommand(Constants.cmdNewTable, (node) => __awaiter(this, void 0, void 0, function* () {
                const reactPanel = new tableDesignerWebViewController_1.TableDesignerWebViewController(this._context, this.tableDesignerService, this._connectionMgr, this._untitledSqlDocumentService, node);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (!self.connectionManager.isConnected(uri)) {
                    ...
                    (0, telemetry_1.sendActionEvent)(telemetryInterfaces_1.TelemetryViews.QueryEditor, telemetryInterfaces_1.TelemetryActions.CreateConnection);
                }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (this.canRunCommand()) {
                ...
                if (node) {
                    ...
                    this._statusview.sqlCmdModeChanged(uri, false);
                    yield this.connectionManager.connectionStore.removeRecentlyUsed(connectionCreds);
                    (0, telemetry_1.sendActionEvent)(telemetryInterfaces_1.TelemetryViews.ObjectExplorer, telemetryInterfaces_1.TelemetryActions.NewQuery, {
                    ...
                    this._statusview.sqlCmdModeChanged(uri, false);
                    (0, telemetry_1.sendActionEvent)(telemetryInterfaces_1.TelemetryViews.CommandPallet, telemetryInterfaces_1.TelemetryActions.NewQuery, undefined, undefined, credentials, this._connectionMgr.getServerInfo(credentials));
                    return true;
                }
            }
            return false;
