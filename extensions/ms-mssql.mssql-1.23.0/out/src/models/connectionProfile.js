    ...
    static createProfile(prompter, connectionStore, context, azureController, accountStore, defaultProfileValues) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            questions.push({
                ...
                shouldPrompt: () => profile.isAzureActiveDirectory() && tenantChoices.length > 1 && !(0, utils_1.getEnableSqlAuthenticationProviderConfig)(),
                onAnswered: (value) => {
            ...
            return prompter.prompt(questions, true).then((answers) => __awaiter(this, void 0, void 0, function* () {
                if (answers && profile.isValidProfile()) {
                    (0, telemetry_1.sendActionEvent)(telemetryInterfaces_1.TelemetryViews.ConnectionPrompt, telemetryInterfaces_1.TelemetryActions.CreateConnectionResult, {
