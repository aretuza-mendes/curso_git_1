...
exports.querySuccess = 'Query succeeded';
exports.queryFailed = 'Query failed';
let loadLocalizedConstants = (locale) => {
    ...
    exports.querySuccess = localize(223, null);
    exports.queryFailed = localize(224, null);
};
